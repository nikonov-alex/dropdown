...
var render = function (state) {
    ...
    return ST.OPTIONS_EMPTY === state.type
        ...
        : (0, jsx_runtime_1.jsxs)("div", { id: state.id, "data-name": state.name, className: "na-dropdown" +
                ...
                (state.type === ST.OPENED ? " opened" : ""), "data-value": (_a = state.value.value) !== null && _a !== void 0 ? _a : state.value.label, tabIndex: 0, children: [(0, jsx_runtime_1.jsx)(Value, tslib_1.__assign({}, state)), state.type === ST.OPENED
